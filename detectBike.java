...
//            
//            
//            positives[i] = imread("bike/bike"+i+".jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
//            Imgproc.resize(positives[i],positives[i],new Size(128,64));
//        }
//        
//        
//        for (int i = 0; i < negatives.length; i++) {
//            negatives[i] = imread("bike/hatch"+i+".jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
//             Imgproc.resize(negatives[i],negatives[i],new Size(128,64));
//        }
Mat pos=imread("bike/bike0.jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
...
//        svm.setKernel(SVM.LINEAR);
        SVM svm = SVM.load("finalbike.yml");
       // svm.save("bike50.yml");
//        
...
//SVM svm= SVM.load("dog.yml");
      ...
      for(int i=0;i<1;i++){
          ...
          String b1 =((predictions.get(i, 0)[0]<0.0)? "Not a bike":"Is a Bike");
