...
//        Mat[] negatives = new Mat[50];
    ...
    public detectflowers(){
//         for (int i = 0; i < positives.length; i++) {
//            
//            
//            positives[i] = imread("flowers/patch"+i+".jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
//            Imgproc.resize(positives[i],positives[i],new Size(128,64));
//        }
//        
//        
//        for (int i = 0; i < negatives.length; i++) {
//            negatives[i] = imread("flowers/hatch"+i+".jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
//             Imgproc.resize(negatives[i],negatives[i],new Size(128,64));
//        }
        Mat pos=imread("flowers/patch0.jpg",Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
...
//        
//        svm.save("finalflower.yml");
       // svm.load("flowers.yml");
       SVM svm = SVM.load("finalflower.yml");
       ...
       // float value = svm.predict(queries);
       
      
      for(int i=0;i<1;i++){
           
           System.out.println(predictions.get(i, 0)[0]);
          String b1 =((predictions.get(i, 0)[0]<0.0)? "Not a Flower":"Is a Flower");
...
//        Mat img= imread("flowers/patch1/jpg");
//        HighGui.namedWindow("here",HighGui.WINDOW_AUTOSIZE);
//        HighGui.imshow("here", img);
//        HighGui.waitKey(0);
